            ...
            <div class="blog-content">
                                ...
                                <article class="blog-post-card h-100">
                                    ...
                                    <div class="blog-post-content">
                                        ...
                                        <div class="blog-post-meta mt-2">
                                            ...
                                            @if($post->category)
                                                <a href="{{ route('blog.category', ['locale' => app()->getLocale(), 'slug' => $post->category->slug]) }}" class="blog-post-category small">
                                                    {{ $post->category->name }}
                                                </a>
                                            @endif
                                        </div>
                ...
                @else
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> {{ __('blog.no_posts_with_tag') }}
                    </div>
                @endif
